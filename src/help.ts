      ...
      this.section(
        ...
        this.wrap(
          [
            ...
            "  $ convos init",
            "",
            "Create a conversation (creates the install's identity on first use):",
            "",
            ...
            "",
            "List conversations in this install's inbox:",
            "",
            "  $ convos conversations list",
            "",
            "IDENTITY MODEL",
            "",
            "  Each install has one XMTP inbox, shared across every conversation.",
            "  Run multiple agents by pointing each at its own CONVOS_HOME.",
            "",
